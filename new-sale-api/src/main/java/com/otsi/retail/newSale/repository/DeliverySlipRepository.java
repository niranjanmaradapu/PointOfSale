...
public interface DeliverySlipRepository extends JpaRepository<DeliverySlipEntity, Long> {
	...
	List<DeliverySlipEntity> findByCreatedDateBetweenAndDsNumber(LocalDate dateFrom, LocalDate dateTo,
			String dsNumber);
	...
	/*DeliverySlipEntity findByCreatedDateBetweenAndDsIdOrderByCreationDateAsc(LocalDate dateFrom,
			LocalDate dateTo, Long dsId);

	List<DeliverySlipEntity> findByCreatedDateBetweenAndStatusOrderByCreationDateAsc(LocalDate dateFrom,
	...
	List<DeliverySlipEntity> findByCreatedDateBetweenOrderByCreationDateAsc(LocalDate dateFrom, LocalDate dateTo);

	DeliverySlipEntity findByCreatedDateBetweenAndDsIdAndDsNumberAndStatusOrderByCreationDateAsc(
			LocalDate dateFrom, LocalDate dateTo, Long dsId, String dsNumber, DSStatus status);

	List<DeliverySlipEntity> findByCreatedDateBetweenAndDsNumberOrderByCreationDateAsc(LocalDate dateFrom,
	...
	Page<DeliverySlipEntity> findByCreatedDateBetweenAndDsNumberAndStoreIdOrderByCreatedDateDesc(LocalDateTime createdDatefrom,
			LocalDateTime createdDateTo, String dsNumber,Long storeId, Pageable pageable);

	Page<DeliverySlipEntity> findByCreatedDateBetweenAndStatusAndStoreIdOrderByCreatedDateDesc(LocalDateTime createdDatefrom,
			LocalDateTime createdDateTo, DSStatus status,Long storeId, Pageable pageable);

	Page<DeliverySlipEntity> findByDsNumberInAndStoreIdOrderByCreatedDateDesc(List<String> dsList, Long storeId, Pageable pageable);

	Page<DeliverySlipEntity> findByStatusAndStoreIdOrderByCreatedDateDesc(DSStatus status, Long storeId, Pageable pageable);
	...
	List<DeliverySlipEntity> findByStatusAndCreatedDateAndStoreId(DSStatus pending, LocalDateTime localDateTime, Long storeId);
	...
	Page<DeliverySlipEntity> findByDsIdInAndStoreIdOrderByCreatedDateDesc(List<Long> dsIds, Long storeId, Pageable pageable);

	Page<DeliverySlipEntity> findByCreatedDateBetweenAndDsIdInAndStoreIdOrderByCreatedDateDesc(
			LocalDateTime createdDatefrom, LocalDateTime createdDateTo, List<Long> dsIds, Long storeId, Pageable pageable);
