...
public class NewSaleController {
	...
	public GateWayResponse<?> saveCustomerDetails(@Valid @RequestBody CustomerVo details) throws DuplicateRecordException {
	...
	public GateWayResponse<?> getCustomerByMobileNumber(@RequestParam String mobileNumber) throws CustomerNotFoundExcecption {
	...
	public GateWayResponse<?> getBarcodeDetails(@RequestParam String barCode, @RequestParam String smId) throws RecordNotFoundException {
	...
	public GateWayResponse<?> saveDeliverySlip(@RequestBody DeliverySlipVo vo, String enumName) throws RecordNotFoundException {
	...
	public GateWayResponse<?> getlistofDeliverySlips(@RequestBody ListOfDeliverySlipVo listOfDeliverySlipVo) throws RecordNotFoundException {
	...
	public GateWayResponse<?> getHsnDetails(@PathVariable double netAmt) throws JsonMappingException, JsonProcessingException,DataNotFoundException {
	...
	public GateWayResponse<?> tagCustomerToInvoice(@PathVariable String mobileNo, @PathVariable String invoiceNo) throws NumberFormatException, CustomerNotFoundExcecption {
	...
	public GateWayResponse<?> tagCustomerToGv(@PathVariable Long userId, @PathVariable Long gvId)throws InvalidInputException,DataNotFoundException {
