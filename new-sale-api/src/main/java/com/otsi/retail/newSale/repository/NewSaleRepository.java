...
public interface NewSaleRepository extends JpaRepository<NewSaleEntity, Long> {
	...
	List<NewSaleEntity> findByCreatedDateBetweenAndStatus(LocalDate dateFrom, LocalDate dateTo,
	...
	List<NewSaleEntity> findByCustomerDetailsMobileNumberAndCreatedDateBetween(String mobileNo, LocalDate fromDate,
			LocalDate toDate);
	...
	List<NewSaleEntity> findByCreatedDateBetweenAndStoreId(LocalDateTime createdDatefrom,
			LocalDateTime createdDatefrom1, long id);
	...
	List<NewSaleEntity> findByUserIdInAndStoreIdAndDomainIdAndCreatedDateBetween(List<Long> userIds, Long storeId,
	...
	List<NewSaleEntity> findByCreatedByAndStoreIdAndDomainIdAndCreatedDateBetween(Long empId, Long storeId,
			Long domainId, LocalDate dateFrom, LocalDate dateTo);
	...
	List<Object[]> getByStoreIdAndDomainIdAndCreatedDateBetween(Long storeId, Long domainId, LocalDate dateFrom,
			LocalDate dateto);
...
//newsaleReport queries
	...
	Page<NewSaleEntity> findByDlSlipDsNumber(String dsNumber, Pageable pageable);

	Page<NewSaleEntity> findByDlSlipLineItemsBarCode(String barcode, Pageable pageable);
