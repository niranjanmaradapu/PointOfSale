 ...
 * @Data
 * 
 * @Table(name = "stores") public class StoresEntity {
 * 
 * @Id
 * 
 * @GeneratedValue(strategy = GenerationType.AUTO) private Long storeId;
 * 
 ...
 *//**
	 ...
	 *//*
		 * 
		 * 
		 * @ManyToMany(mappedBy = "storeEntity", cascade = CascadeType.ALL) private
